...
export const metadata = {
  title: "Baltasar Fucked This Woman Like No OtherCelebrities",
  description:
    "Watch the viral Baltasar video that is trending online. Stream the full clip and discover more related trending videos in one place.",
};

export default function SimplePost1() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 20 }}>
      ...
      <h1 className="video-title">
        Baltasar Fucked This Woman Like No OtherCelebrities
      </h1>

      <video width="100%" height="500" className="custom-video" controls>
        <source src="https://res.cloudinary.com/diiwlqlh2/video/upload/v1771953742/XiaoYing_Video_1732439622603_uwqrx9.mp4" />
