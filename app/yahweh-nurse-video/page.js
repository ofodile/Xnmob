...
export const metadata = {
  title: "Yahweh nurse video",
  description:
    "Watch the Trending Yahweh nurse video that got people online. Stream the full clip and discover more related trending videos in one place.",
};

export default function SimplePost6() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 20 }}>
      ...
      <video width="100%" height="500" className="custom-video" controls>
        <source src="https://res.cloudinary.com/diiwlqlh2/video/upload/v1771979232/VID_20241130_103014_007_z8lfoz.mp4" />
