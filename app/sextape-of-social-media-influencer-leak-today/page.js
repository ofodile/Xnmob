...
export const metadata = {
  title: "Sextape Of Social Media Influencer Leak Today",
  description:
    "Watch the Sextape Of Social Media Influencer Leak Today. Stream the full clip and discover more related trending videos in one place.",
};

export default function SimplePost7() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: 20 }}>
      ...
      <h1 className="video-title">
        Sextape Of Social Media Influencer Leak Today
      </h1>

      <video width="100%" height="500" className="custom-video" controls>
        <source src="https://res.cloudinary.com/diiwlqlh2/video/upload/v1771979823/Sextape-Of-Social-Media-Influencer-Leak-Today_flkw99.mp4" />
